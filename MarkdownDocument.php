...
class MarkdownDocument {
	 ...
	 * @since 0.1.0
	 */
	const NOSUPERSCRIPT		= 0x00000100;
	 ...
	 * @since 0.1.0
	 */
	const NOSTRIKETHROUGH	= 0x00000800;
	 ...
	 * @since 1.0.0
	 */
	const EXTRA_FOOTNOTE	= 0x00200000;
